...
while True:##get sensor value for a while
    # BMX055 Accl address, 0x18(24)
    ...
    print ("Rotation (x,y,z) : {},{},{}".format(xGyro,yGyro,zGyro))
    print ("Magnetic field (x,y,z) : {},{},{}".format(xMag,yMag,zMag))
    time.sleep(0.1)
    # Output data to screen
    #print ("Acceleration (x,y,z) : (%d,%d,%d)" %xAccl,%yAccl,%zAccl)
    #print ("Rotation (x,y,z) : (%d,%d,%d)" %xGyro,%yGyro,%zGyro)
    #print ("Magnetic field (x,y,z) : (%d,%d,%d)" %xMag,%yMag,%zMag)
